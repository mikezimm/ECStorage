...
export function aboutTable() {
    ...
    table.rows.push( ['2021-08-17x', '1.1.15.4',    <span>Mfg Provisioning options</span>,                ''] );
    table.rows.push( ['2021-08-10', '1.1.15.3',    <span>Permissions History tweaks</span>,                ''] );
    table.rows.push( ['2021-08-09', '1.1.15.2',    <span>Improve permissions history snapshots and compare changes over time.</span>,                ''] );
    table.rows.push( ['2021-08-02', '1.1.14.9',    <span>Standardize permissions history with Pivot Tiles.</span>,                ''] );
    table.rows.push( ['2021-07-28', '1.1.14.8',    <span>Add list permissions history pane</span>,                ''] );
    table.rows.push( ['2021-07-19', '1.1.14.6',    <span>Improve Groups styling, SPAssists</span>,                ''] );
